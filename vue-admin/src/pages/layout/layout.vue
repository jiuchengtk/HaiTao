<template>
  <div class="layout">
    <div class="siderbar-wrapper" :style="{width: this.isCollapsed?'64px':'200px'}">
      ...
      <el-menu
        ...
        <template v-for="(item, index) in sider_menu_data">
          ...
          <el-submenu v-else :index="item.path" v-bind:key='item.path'>
            <template slot="title">
              <i :class="item.icon"></i>
              <span slot="title">{{item.title}}</span>
            </template>
    ...
    <div class="topbar-wrapper" :style="{left: this.isCollapsed?'64px':'200px'}">
      ...
      <div class="title float-left">海淘商城 后台管理系统</div>
      ...
      return {
        sider_menu_data: [
          ...
          },
          {
            ...
            children: [
              {path: '/merchandiseControl/classify', title: '分类管理'},
              {path: '/merchandiseControl/brand', title: '品牌管理'},
              {path: '/merchandiseControl/list', title: '商品列表'}
            ]
          },
          {
            path: '/charts',
            ...
            children: [
              {path: '/charts/bar', title: '柱状图分析'},
              {path: '/charts/line', title: '折线图分析'},
              {path: '/charts/pie', title: '饼图分析'}
            ]
          },
          // {
          //   path: '/form',
          ...
          // },
          {
            ...
            children: [
              {path: '/system/systemSetting', title: '系统设置'}
            ]
          },
          {
            path: '/user',
            ...
            children: [
              {path: '/user/userCount', title: '用户统计'},
              {path: '/user/userManga', title: '用户管理'}
            ]
          },
          {
            path: '/access',
            ...
            children: [
              {path: '/access/roleManga', title: '角色管理'},
              {path: '/access/personalManga', title: '人员管理'},
              {path: '/access/authorityManga', title: '权限管理'}
            ]
          }
          // {
          //   path: '/log/index',
